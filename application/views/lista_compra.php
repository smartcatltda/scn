                ...
                <table id="tabla_compra" class="table-content" cellspacing="0" border="1" width="983" style="font-size: 12px; font-weight: normal;">
                    ...
                    foreach ($compras as $fila):
                        ...
                        <tr align="center">
                            ...
                            <td width="70"><input type="image" src="css/images/eliminar.png" onclick="eliminar_compra('<?= $fila->id_detalle_compra ?>', '<?= $fila->codigo_producto ?>', '<?= $fila->cantidad ?>')" style="width:24px;"/></td>
                        </tr>
                        <?php
                    endforeach;
                    ?>
