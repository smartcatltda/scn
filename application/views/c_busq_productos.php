        ...
        <tr>
            <td>
                <div style="width:1000px; height:218px; overflow:auto;">
                    <table id="tabla_c_productos" class="table-content" cellspacing="0" border="1" width="983" style="font-size: 12px; font-weight: normal;">
                        <?php
                        foreach ($productos as $fila):
                            ...
                            <tr align="center">
                                ...
                                <td width="73"><input type="image" src="css/images/arrow-left-icon.png" onclick="selec_c_busq_producto('<?= $fila->codigo_producto ?>')" style="width:24px;" /></td>
                            </tr>
                            <?php
                        endforeach;
                    endif;
